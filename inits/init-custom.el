...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (forge jupyter projectile which-key use-package try smartparens smart-mode-line rainbow-delimiters projectile org-pdfview org-bullets olivetti ob-ipython magit iedit gruvbox-theme elpy dashboard counsel adaptive-wrap ace-window))))
